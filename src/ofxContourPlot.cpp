...
void CContour::SetFieldFcn(double (*_pFieldFcn)(ofApp*,double, double),ofApp * call_object) 
{	
	app = call_object;
	m_pFieldFcn=_pFieldFcn;
};

void CContour::SetDrawFcn(void (*_drawPlotFcn)(ofApp*,int,int,int,int,int),ofApp * call_object) 
{	
	app = call_object;
	m_drawPlotFcn=_drawPlotFcn;
};
...
void CContour::ExportLine(int iPlane,int x1, int y1, int x2, int y2) {
	(*m_drawPlotFcn)(app,iPlane,x1,y1,x2,y2);
}